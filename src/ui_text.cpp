...
Translations{{
    ...
    {L"Getting metadata", L"メタデータ取得中"},
    {L"Unable to start metadata retrieval.",
     L"メタデータ取得を開始できませんでした。"},
    ...
    {L"Playlist Files (*.m3u;*.m3u8)\0*.m3u;*.m3u8\0All Files (*.*)\0*.*\0\0",
     L"プレイリストファイル (*.m3u;*.m3u8)\0*.m3u;*.m3u8\0すべてのファイル (*.*)\0*.*\0\0"},
    {L"Open Audio Files", L"音声ファイルを開く"},
    {L"Import Playlist", L"プレイリストをインポート"},
    ...
    {L"No playlist is selected.\n\nLoad this file as a new playlist?\n\n",
     L"プレイリストが選択されていません。\n\nこのファイルを新しいプレイリストとして読み込みますか？\n\n"},
    {L"Load this playlist file?\n\n",
     L"このプレイリストファイルを読み込みますか？\n\n"},
    {L"\n\nYes: Add as a new playlist\nNo: Append to the current playlist\nCancel: Do nothing",
     L"\n\nはい: 新しいプレイリストとして追加\nいいえ: 現在のプレイリストへ追加\nキャンセル: 何もしない"},
    {L"Failed to load the playlist file.\nThe file must be a readable M3U8 or M3U playlist.",
     L"プレイリストファイルを読み込めませんでした。\n読み取り可能なM3U8またはM3Uファイルである必要があります。"},
    {L"Remove \"", L"「"},
